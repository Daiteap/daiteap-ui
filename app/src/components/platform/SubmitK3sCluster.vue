    ...
    <div v-if="!loading">
      ...
      <div class="stepper d-flex flex-column mt-5 ml-2">
        ...
        <div class="d-flex mb-1">
          ...
          <div>
            <h5 class="text-dark">Preparing for K3s installation</h5>
            <p
              class="lead text-muted pb-3"
            >Making all the necessary preparations for K3s cluster installation.</p>
          </div>
        </div>
        <div class="d-flex mb-1">
          <div class="d-flex flex-column pr-4 align-items-center">
        ...
        <div class="d-flex mb-1">
          ...
          <div>
            <h5 class="text-dark">Installing K3s</h5>
            <p class="lead text-muted pb-3">Installing K3s cluster in the cloud.</p>
          </div>
        </div>
        <div class="d-flex mb-1">
          <div class="d-flex flex-column pr-4 align-items-center">
          ...
          <div>
            <h5 class="text-dark">Downloading K3s config file</h5>
