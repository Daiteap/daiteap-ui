<template>
  <div class="container">
    ...
    ></QuotaExceededModal>
    <h3 class="d-flex justify-content-center">Create K3S cluster</h3>
    <br />
    <div class="columns">
      <div class="column is-11 is-offset-0">
        <div v-if="errorMsg" class="alert alert-warning" role="alert" style="text-align: left; color: black;">{{ errorMsg }}</div>
        <horizontal-stepper
          :steps="clusterSteps"
          @completed-step="completeStep"
          :top-buttons="true"
          @active-step="isStepActive"
          @stepper-finished="StepK3SSubmit"
        ></horizontal-stepper>
      </div>
    </div>
  </div>
