<template>
    <v-card class="" :loading="loading > 0">
        <toolbar
            :path="path"
            ...
            v-on:file-uploaded="refreshPending = true"
        ></toolbar>
        <v-row no-gutters>
...
const endpoints = {
    list: { url: "/storage/{storage}/list?path={path}", method: "post" },
...
export default {
    ...
    created() {
        availableStorages[0].name = this.bucket.name;
