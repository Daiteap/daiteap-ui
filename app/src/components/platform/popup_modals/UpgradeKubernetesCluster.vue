<template>
  <b-modal centered id="bv-modal-upgradekubernetescluster" hide-footer>
        ...
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group col-lg-8">
            <div v-if="kubeUpgradeStatus == -1">
              Upgrade failed
              <pre
                v-if="errorMsg != undefined && errorMsg != ''"
                id="errorMsg"
                >{{ errorMsg }}</pre
              >
            ...
            <br />
            <div>
              Changing the master version can result in several minutes of
              control plane downtime. This operation starts immediately, and is
              not reversible.
            </div>
          </div>
          ...
          <div class="form-group col-lg-8">
            <div class="col-lg-16">
              <input
                v-on:click="upgradeKubernetesCluster"
                :disabled="$v.$invalid"
                type="button"
...
export default {
  ...
  mounted() {
    this.getKubernetesAvailableUpgradeVersions();
  ...
  methods: {
    ...
    closeModal() {
      this.$bvModal.hide("bv-modal-upgradekubernetescluster");
    },
  },
  destroyed() {
